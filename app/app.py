...
class ArtworkForm(FlaskForm):
    ...
    printings = IntegerField('Number of allowed printings of the artwork', validators=[Length(min=0, max=122209090900050)], render_kw={"placeholder": "Default is 0"})
...
def generate_token_string_builder():
    ...
    if form.validate_on_submit():
        ...
        artwork_type = form.artwork_type.data
